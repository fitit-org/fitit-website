...
class Register extends React.Component<
  ...
  {
    name: nameTypes
    surname: surnameTypes
    registerMail: mailTypes
    registerPassword: registerPasswordTypes
    registerPassword2: registerPasswordTypes
    registerCode: registerCodeTypes
  }
> {
  ...
  handleChange(event: any): void {
    switch (event.target.id) {
      ...
      case 'registerSurname':
        ...
        break
      case 'registerMail':
        this.setState({ registerMail: { value: event.target.value } })
        break
      ...
      case 'registerPassword2':
        ...
        break
      case 'registerCode':
        this.setState({ registerCode: { value: event.target.value } })
        break
    }
  }
  ...
  handleBlur(event: any): void {
    ...
    if (
      event.target.id === 'registerName' ||
      event.target.id === 'registerSurname'
    ) {
  ...
  handleSubmit(event: any): void {
    ...
    if (
      nameSurnameValidation('Imię', this.state.name.value) === '' &&
      nameSurnameValidation('Nazwisko', this.state.surname.value) === '' &&
      mailValidation(this.state.registerMail.value) === '' &&
      registerPasswordValidation(this.state.registerPassword.value) === '' &&
      this.state.registerPassword.value ===
        this.state.registerPassword2.value &&
      codeValidation(this.state.registerCode.value) === ''
    ) {
